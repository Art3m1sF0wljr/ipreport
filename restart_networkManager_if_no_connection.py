...
CHECK_INTERVAL = 200  # seconds
CONNECTION_TIMEOUT = 30  # seconds for all network operations
...
def reboot_system():
    ...
    try:
        subprocess.run(['sudo', 'systemctl', 'restart', 'NetworkManager'], check=True, timeout=30)
...
if __name__ == "__main__":
    try:
        ...
        logging.error("Attempting restart network managerdue to fatal startup error...")
        reboot_system()
        raise
